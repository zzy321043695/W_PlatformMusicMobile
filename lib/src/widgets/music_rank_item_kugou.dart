 ...
 * @Description: 
 * @Author: zhengzhenyu
 * @Date: 2021-01-31 00:24:54
 * @LastEditors: zhengzhenyu
 * @LastEditTime: 2021-01-31 20:17:49
 */
...
import 'package:music_learn/src/pages/music/music_list_kugou.dart';
import 'package:music_learn/src/utils/log_utils.dart';
import 'package:music_learn/src/utils/navigator_utils.dart';

class MusicRankItemKugou extends StatefulWidget {
  final String topId;
  final String source;
  final String picUrl;
...
class _MusicRankItemState extends State<MusicRankItemKugou> {
  @override
        ...
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasError) {
            ...
            return InkWell(
              ...
              child: Column(
                children: [
                  rankListItem(height, snapshot.data, widget.picUrl), //热歌榜
                ],
              ),
            );
          }
  ...
  Widget rankListItem(double height, dynamic rankList, String picUrl) {
    return Container(
